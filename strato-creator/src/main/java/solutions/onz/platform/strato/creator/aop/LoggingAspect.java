 ...
 * All rights reserved.
 */
package solutions.onz.platform.strato.creator.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(solutions.onz.platform.strato.creator.repositories.*)"
            + " || within(solutions.onz.platform.strato.creator.services..*)"
            + " || within(solutions.onz.platform.strato.creator.api.rest..*)")
